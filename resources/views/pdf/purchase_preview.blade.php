...
<head>
    ...
    <title>PURCHASE-{{ $data->invoice_no }}-{{ date('Ymd-his') }}</title>
...
@endphp --}}
    ...
    <div class="pdf_name">Purchase Order Invoice</div>
    ...
    <div class="tbl-header-wrapper">
        <table class="tbl-supplier-info">
            <tr>
                ...
                <td>
                    {{ $data['supplier']['profile']['firstname'] }} {{ $data['supplier']['profile']['lastname'] }}
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    @if ($data['supplier'])
                    {{ $data['supplier']['profile']['taxpayer_identification'] }}
                    @endif
                </td>
            </tr>
            <tr>
        ...
        <table class="tbl-purchase-info">
            <tr>
                ...
                <td>
                    {{ $data['date_purchased'] ? date('F d, Y', strtotime($data['date_purchased'])) : '' }}
                </td>
            </tr>
            <tr>
                <td>
    ...
    <div class="purchase-details-wrapper">
        <table class="tbl-purchase-details">
            ...
            <tbody>
                @foreach ($data['purchase_details'] as $purchase_detail)
                <tr>
                    ...
                    <td class="text-right">
                        <span class="DejaVuSans">₱</span> {{ $purchase_detail['cost'] }}
                    </td>
                    <td class="text-right">
                        <span class="DejaVuSans">₱</span> {{ $purchase_detail['total_cost'] }}
                    </td>
                    <td class="text-right">
                        <span class="DejaVuSans">₱</span> {{ number_format($purchase_detail['vat'], 2) }}
                    </td>
                    <td class="text-right">
                        <span class="DejaVuSans">₱</span> {{ number_format($purchase_detail['gross_amount'], 2) }}
                    </td>
                </tr>
                @endforeach
            </tbody>
