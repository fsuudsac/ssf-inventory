...
<head>
    ...
    <title>Faculty Load Monitoring Report</title>
    ...
    <style>
        ...
        /* add padding top and bottom but not on first page */
...
<body>
    ...
    <div class="header-wrapper">
        ...
        <div class="logo">
            ...
            {{-- <img class="guidance_logo" src="{{ $guidance_logo }}" alt="guidance_logo" height="100px" width="100px"> --}}
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($item->status_update)
                                <div>Justification Status: {{ $item->status_update }}</div>
                            @endif
                            @if ($item->update_remarks)
                                <div>Justification Remarks: {{ $item->update_remarks }}</div>
                            @endif
                        </td>
                        <td>
                            @if ($item->faculty_no)
                                <div>Faculty No.: {{ $item->faculty_no }}</div>
                            @endif
                            @if ($item->fullname)
                            ...
                            @endif
                            @if ($item->code)
                                <div>Subject: {{ $item->code }}</div>
                            @endif
                            @if ($item->school_year)
                                <div>School Year: {{ $item->school_year }}</div>
                            @endif
                            @if ($item->semester)
