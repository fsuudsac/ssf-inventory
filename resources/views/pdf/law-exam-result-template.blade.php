...
<body>
    ...
    <h3 style="margin: 0px 0px 10px 40px;">LAW SCHOOL QUALIFYING (LSQT)</h3>
    <table class="standard-score" style="padding:20px 0px 0px 200px">
        ...
        <tbody style="margin-left: 100px">
            <tr>
                <td class="standard-score-subject">Critical Thinking (CT)</td>
                <td class="standard-score-score">{{ $applicants['ct'] }}</td>
            </tr>

            <tr>
                <td class="standard-score-subject">Verbal Ability (VA)</td>
                <td class="standard-score-score">{{ $applicants['va'] }}</td>
            </tr>

            <tr style="padding-bottom: 20px;">
                <td class="standard-score-subject">Quantitative Ability (QA)</td>
                <td class="standard-score-score">{{ $applicants['qa'] }}</td>
            </tr>
        </tbody>
    </table>


    <table class="general-score" style="padding:10px 0px 0px 200px">
        <thead>
            <tr>
