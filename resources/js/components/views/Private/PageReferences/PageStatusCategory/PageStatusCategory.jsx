...
export default function PageStatusCategory(props) {
    ...
    const { data: dataSource, refetch: refetchSource } = GET(
        `api/status_category?${new URLSearchParams(tableFilter)}`,
    ...
    const {
        ...
        isLoading: isLoadingDeleteStatusCategory,
    } = POST(`api/status_category_archived`, "status_category_list");
    ...
    const handleSelectedArchived = () => {
        ...
        mutateDeleteStatusCategory(data, {
            onSuccess: (res) => {
                if (res.success) {
    ...
    useTableScrollOnTop("tbl_status_category", location);

    return (
        <Row id="tbl_wrapper_status_category">
                        ...
                        <div className="tbl-top-filter">
                            <Flex gap={15}>
                                ...
                                {selectedRowKeys.length > 0 && (
                                    <Popconfirm
                                        ...
                                        disabled={isLoadingDeleteStatusCategory}
                                    >
                                        <Button
                                            name="btn_active_archive"
                                            loading={
                                                isLoadingDeleteStatusCategory
                                            }
                            ...
                            <Flex>
                                ...
                                <TablePagination
                                    ...
                                    tblIdWrapper="tbl_wrapper_status_category"
                                />
                            </Flex>
                        </div>
                    </Col>
