...
export default function PageSection(props) {
    ...
    const { data: dataSource, refetch: refetchSource } = GET(
        `api/section?${new URLSearchParams(tableFilter)}`,
        "section_list"
    );
    ...
    const { mutate: mutateDeleteSection, isLoading: isLoadingDeleteSection } =
        POST(`api/section_archived`, "section_list");
    ...
    useTableScrollOnTop("tbl_section", location);

    return (
        <Row id="tbl_wrapper_section">
                                ...
                                {selectedRowKeys.length > 0 && (
                                    ...
                                    >
                                        <Button
                                            ...
                                            loading={isLoadingDeleteSection}
