...
export default function PageDaySchedule(props) {
    ...
    const { data: dataSource, refetch: refetchSource } = GET(
        `api/day_schedule?${new URLSearchParams(tableFilter)}`,
        "day_schedule_list"
    );
    ...
    const {
        ...
        isLoading: isLoadingDeleteDaySchedule,
    } = POST(`api/day_schedule_archived`, "day_schedule_list");
    ...
    useTableScrollOnTop("tbl_day_schedule", location);

    return (
        <Row id="tbl_wrapper_day_schedule">
                        ...
                        <div className="tbl-top-filter">
                            <Flex gap={15}>
                                ...
                                {selectedRowKeys.length > 0 && (
                                    <Popconfirm
                                        ...
                                        disabled={isLoadingDeleteDaySchedule}
                                    >
                                        <Button
                                            name="btn_active_archive"
                                            loading={isLoadingDeleteDaySchedule}
                            ...
                            <Flex>
                                ...
                                <TablePagination
                                    ...
                                    tblIdWrapper="tbl_wrapper_day_schedule"
                                />
                            </Flex>
                        </div>
                    </Col>
