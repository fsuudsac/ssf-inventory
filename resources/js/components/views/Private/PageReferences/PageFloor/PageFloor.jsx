...
export default function PageFloor(props) {
    ...
    const { data: dataSource, refetch: refetchSource } = GET(
        `api/floor?${new URLSearchParams(tableFilter)}`,
        "floor_list"
    );
    ...
    const { mutate: mutateDeleteFloor, isLoading: isLoadingDeleteFloor } = POST(
        `api/floor_archived`,
        "floor_list"
    );
    ...
    useTableScrollOnTop("tbl_floor", location);

    return (
        <Row id="tbl_wrapper_floor">
                        ...
                        <div className="tbl-top-filter">
                            <Flex gap={15}>
                                ...
                                {selectedRowKeys.length > 0 && (
                                    <Popconfirm
                                        ...
                                        disabled={isLoadingDeleteFloor}
                                    >
                                        <Button
                                            name="btn_active_archive"
                                            loading={isLoadingDeleteFloor}
                            ...
                            <Flex>
                                ...
                                <TablePagination
                                    ...
                                    tblIdWrapper="tbl_wrapper_floor"
                                />
                            </Flex>
                        </div>
                    </Col>
